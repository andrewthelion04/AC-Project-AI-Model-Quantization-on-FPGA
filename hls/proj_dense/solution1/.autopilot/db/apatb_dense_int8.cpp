...
// wrapc file define:
#define AUTOTB_TVIN_input_image "../tv/cdatafile/c.dense_int8.autotvin_input_image.dat"
#define AUTOTB_TVOUT_input_image "../tv/cdatafile/c.dense_int8.autotvout_input_image.dat"
#define AUTOTB_TVIN_output_scores "../tv/cdatafile/c.dense_int8.autotvin_output_scores.dat"
#define AUTOTB_TVOUT_output_scores "../tv/cdatafile/c.dense_int8.autotvout_output_scores.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.dense_int8.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.dense_int8.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.dense_int8.autotvout_gmem.dat"
...
extern "C"
void dense_int8_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_dense_int8_hw(void* __xlx_apatb_param_input_image, void* __xlx_apatb_param_output_scores)
{
  static hls::sim::Byte<4> __xlx_offset_byte_param_input_image;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_input_image),
#endif
  };
  port0.param = &__xlx_offset_byte_param_input_image;

  static hls::sim::Byte<4> __xlx_offset_byte_param_output_scores;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_output_scores),
#endif
  };
  port1.param = &__xlx_offset_byte_param_output_scores;
  ...
  port2.param = { __xlx_apatb_param_input_image, __xlx_apatb_param_output_scores };
  port2.mname = { "input_image", "output_scores" };
  port2.nbytes = { 3136, 40 };
  ...
  __xlx_offset_byte_param_input_image = port2.offset[0]*4;
  __xlx_offset_byte_param_output_scores = port2.offset[1]*4;
  ...
  try {
    ...
    dense_int8_hw_stub_wrapper(__xlx_apatb_param_input_image, __xlx_apatb_param_output_scores);
