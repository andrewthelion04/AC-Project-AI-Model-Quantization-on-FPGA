; ModuleID = 'C:/Users/leupe/AC-Project-AI-Model-Quantization-on-FPGA/hls/proj_dense/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline willreturn
define void @apatb_dense_int8_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="784" "maxi" %input_image, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="10" "maxi" %output_scores) local_unnamed_addr #0 {
entry:
  %0 = bitcast float* %input_image to [784 x float]*
  %input_image_copy = alloca [784 x float], align 512
  %1 = bitcast float* %output_scores to [10 x float]*
  %output_scores_copy = alloca [10 x float], align 512
  call fastcc void @copy_in([784 x float]* nonnull %0, [784 x float]* nonnull align 512 %input_image_copy, [10 x float]* nonnull %1, [10 x float]* nonnull align 512 %output_scores_copy)
  call void @apatb_dense_int8_hw([784 x float]* %input_image_copy, [10 x float]* %output_scores_copy)
  call void @copy_back([784 x float]* %0, [784 x float]* %input_image_copy, [10 x float]* %1, [10 x float]* %output_scores_copy)
  ret void
}
...
declare void @apatb_dense_int8_hw([784 x float]*, [10 x float]*)
...
declare void @dense_int8_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull)

define void @dense_int8_hw_stub_wrapper([784 x float]*, [10 x float]*) #5 {
entry:
  ...
  call void @dense_int8_hw_stub(float* %2, float* %3)
