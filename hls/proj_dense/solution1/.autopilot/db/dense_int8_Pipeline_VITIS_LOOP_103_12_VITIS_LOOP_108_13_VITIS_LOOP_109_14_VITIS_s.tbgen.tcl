set moduleName dense_int8_Pipeline_VITIS_LOOP_103_12_VITIS_LOOP_108_13_VITIS_LOOP_109_14_VITIS_s
set isTopModule 0
...
set cdfgNum 6
set C_modelName {dense_int8_Pipeline_VITIS_LOOP_103_12_VITIS_LOOP_108_13_VITIS_LOOP_109_14_VITIS_}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict layer2_out { MEM_WIDTH 8 MEM_SIZE 12544 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln103 int 62 regular  }
	{ layer2_out int 8 regular {array 12544 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "input_image","offset": { "type": "dynamic","port_name": "input_image","bundle": "control"},"direction": "READONLY"},{"cName": "output_scores","offset": { "type": "dynamic","port_name": "output_scores","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln103", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "layer2_out", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln103 sc_in sc_lv 62 signal 1 } 
	{ layer2_out_address0 sc_out sc_lv 14 signal 2 } 
	{ layer2_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ layer2_out_q0 sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln103", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln103", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "layer2_out", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "125456", "Max" : "125456"}
	, {"Name" : "Interval", "Min" : "125441", "Max" : "125441"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln103 { ap_none {  { sext_ln103 in_data 0 62 } } }
	layer2_out { ap_memory {  { layer2_out_address0 mem_address 1 14 }  { layer2_out_ce0 mem_ce 1 1 }  { layer2_out_q0 mem_dout 0 8 } } }
}
