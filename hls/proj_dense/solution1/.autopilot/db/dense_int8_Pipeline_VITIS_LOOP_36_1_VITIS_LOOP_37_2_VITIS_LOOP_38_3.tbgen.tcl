set moduleName dense_int8_Pipeline_VITIS_LOOP_36_1_VITIS_LOOP_37_2_VITIS_LOOP_38_3
set isTopModule 0
...
set cdfgNum 6
set C_modelName {dense_int8_Pipeline_VITIS_LOOP_36_1_VITIS_LOOP_37_2_VITIS_LOOP_38_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict layer1_out { MEM_WIDTH 8 MEM_SIZE 6272 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ input_image int 64 regular  }
	{ layer1_out int 8 regular {array 6272 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "input_image","offset": { "type": "dynamic","port_name": "input_image","bundle": "control"},"direction": "READONLY"},{"cName": "output_scores","offset": { "type": "dynamic","port_name": "output_scores","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "input_image", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "layer1_out", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ input_image sc_in sc_lv 64 signal 1 } 
	{ layer1_out_address0 sc_out sc_lv 13 signal 2 } 
	{ layer1_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ layer1_out_we0 sc_out sc_logic 1 signal 2 } 
	{ layer1_out_d0 sc_out sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_image", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "input_image", "role": "default" }} , 
 	...
 	{ "name": "layer1_out_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "layer1_out", "role": "we0" }} , 
 	{ "name": "layer1_out_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "layer1_out", "role": "d0" }} , 
...
set ArgLastReadFirstWriteLatency {
	dense_int8_Pipeline_VITIS_LOOP_36_1_VITIS_LOOP_37_2_VITIS_LOOP_38_3 {
		...
		layer1_out {Type O LastRead -1 FirstWrite 44}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "56485", "Max" : "56485"}
	, {"Name" : "Interval", "Min" : "56457", "Max" : "56457"}
]}
...
set Spec2ImplPortList { 
	...
	input_image { ap_none {  { input_image in_data 0 64 } } }
	layer1_out { ap_memory {  { layer1_out_address0 mem_address 1 13 }  { layer1_out_ce0 mem_ce 1 1 }  { layer1_out_we0 mem_we 1 1 }  { layer1_out_d0 mem_din 1 8 } } }
}
