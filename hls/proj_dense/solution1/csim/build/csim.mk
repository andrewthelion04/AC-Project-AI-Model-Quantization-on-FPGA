...
HLS_SOURCES = ../../../../tb_dense.cpp ../../../../dense_int8.cpp
...
$(ObjDir)/tb_dense.o: ../../../../tb_dense.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../tb_dense.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_dense.d

$(ObjDir)/dense_int8.o: ../../../../dense_int8.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../dense_int8.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=dense_int8 $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/dense_int8.d
